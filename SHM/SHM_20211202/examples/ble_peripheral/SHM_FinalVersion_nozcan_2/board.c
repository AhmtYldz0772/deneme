...
void BoardInitMcu(void)
{
    ...
    /* Sx1272 spi Initialise */
    SpiInit(&SX1272.Spi, SPI_1, RADIO_MOSI, RADIO_MISO, RADIO_SCLK, NRF_DRV_SPI_PIN_NOT_USED, NRF_DRV_SPI_MODE_0);

    SX1272IoInit();

    /* Adxl355 Spi Initialise */
    SpiInit(&Adxl355.Spi, SPI_2, SPIADXL_MOSI_PIN, SPIADXL_MISO_PIN, SPIADXL_SCK_PIN, NRF_DRV_SPI_PIN_NOT_USED, NRF_DRV_SPI_MODE_0);

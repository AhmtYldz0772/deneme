  ...
  switch( mlmeConfirm->MlmeRequest )
  {
    case MLME_JOIN:
      ...
      if( mlmeConfirm->Status == LORAMAC_EVENT_INFO_STATUS_OK )
      {
          ...
          #ifdef LORAMAC_CLASSB_ENABLED     //nozcantest
#if defined( USE_DEVICE_TIMING )            //nozcantest
              LORA_DeviceTimeReq();         //nozcantest
#else              
              LORA_BeaconTimeReq();         //nozcantest
#endif /* USE_DEVICE_TIMING */              //nozcantest
#endif /* LORAMAC_CLASSB_ENABLED */         //nozcantest
      }
      else
      {
    ...
    case MLME_LINK_CHECK:
     printf("check in lora MLME_LINK_CHECK %d",mlmeConfirm->Status );
      if( mlmeConfirm->Status == LORAMAC_EVENT_INFO_STATUS_OK )
      {
          // Check DemodMargin
          // Check NbGateways

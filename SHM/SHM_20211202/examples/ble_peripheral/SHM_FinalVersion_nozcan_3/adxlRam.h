...
#define READ_SENSOR_DATA_PERIOD   8        //ms
#define DATA_RDY 0x01
#define MAX_FIFO_SIZE 96                    //artirilacak
...
extern receivedMaxData_t X_Max5Data[MAX_VALUE_COUNT];
extern receivedMaxData_t Y_Max5Data[MAX_VALUE_COUNT];
